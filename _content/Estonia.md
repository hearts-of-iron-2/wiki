...
power](/wiki/Micro_power "Micro power"){.mw-redirect} in 1936, 1938 and
1939 scenario. In other scenarios, Estonia can be created by nations
...
-   [[ 4 ]{.tocnumber} [ Tech Teams ]{.toctext}](#Tech_Teams)
...
-   **Capital:**
    [Tallinn](/wiki/index.php?title=Tallinn&action=edit&redlink=1 "Tallinn (page does not exist)"){.new}
