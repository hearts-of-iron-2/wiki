...
**Each occupied province costs 1 TC** _but that can be reduced by inf/supply research_ . The formula for each supply tech level uses the TC_occupied_mod value = 20 found in each inf/supply tech. These are cumulatively added which results in these factors:
