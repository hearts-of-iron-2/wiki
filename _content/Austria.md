...
Once Italy is under your control, you need to build some sort of navy, especially [transport ships](/wiki/Transport_ships "Transport ships") . This is where modding the game comes in useful, as Austria otherwise has grave difficulties doing this. Well, you can get [transports](/wiki/Transport "Transport") anyway.
