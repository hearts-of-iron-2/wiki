...
with regard to HQ units as kindly posted by **Fiendix** .
...
## [ HQ Command Abilities ]{#HQ_Command_Abilities .mw-headline}
...
attack](/wiki/index.php?title=Movement_is_attack&action=edit&redlink=1 "Movement is attack (page does not exist)"){.new}
...
## [ Battle Planning ]{#Battle_Planning .mw-headline}
...
### [ Adding a Second HQ ]{#Adding_a_Second_HQ .mw-headline}
...
### [ ]{#Three_HQ_Units??} [ Three HQ Units?? ]{#Three_HQ_Units.3F.3F .mw-headline}
...
## [ The Results ]{#The_Results .mw-headline}
