...
- [[ 6 ]{.tocnumber} [ Events ]{.toctext}](#Events)
  ...
  - [[ 6.4 ]{.tocnumber} [ Asia-Pacific and Africa
    ]{.toctext}](#Asia-Pacific_and_Africa)
...
### [ ]{#Commonwealth*AI*(ENG+SAF+CAN+AST+NZL)} [ Commonwealth AI (ENG+SAF+CAN+AST+NZL) ]{#Commonwealth*AI*.28ENG.2BSAF.2BCAN.2BAST.2BNZL.29 .mw-headline}
...
### [ ]{#French*AI*(FRA+VIC)} [ French AI (FRA+VIC) ]{#French*AI*.28FRA.2BVIC.29 .mw-headline}
...
### [ ]{#German*AI*(GER)} [ German AI (GER) ]{#German*AI*.28GER.29 .mw-headline}
...
### [ ]{#Italian*AI*(ITA)} [ Italian AI (ITA) ]{#Italian*AI*.28ITA.29 .mw-headline}
...
### [ ]{#Japanese*AI*(JAP)} [ Japanese AI (JAP) ]{#Japanese*AI*.28JAP.29 .mw-headline}
...
### [ ]{#Soviet*Union_AI*(SOV)} [ Soviet Union AI (SOV) ]{#Soviet*Union_AI*.28SOV.29 .mw-headline}
...
### [ ]{#United*Staes_AI*(USA)} [ United Staes AI (USA) ]{#United*Staes_AI*.28USA.29 .mw-headline}
...
- Moved the alliance command in the Croatian Independance events from
  the CRO event to the GER event so that Croatia now actually _joins_
