...
Communist China starts with a rather large manpower pool, and also enjoys the blueprints for "infantry 1936", which makes infantry the most suited unit to produce from the start. Do not overlook the [usefulness of militia](/wiki/Militia_Strategy_Guide "Militia Strategy Guide") : they can be lifesavers when you need to defend a front while sending your best troops to an offensive elsewhere. Artillery brigades are also very useful, to hold the frontline or to launch offensives with reduced losses against Japanese troops.
